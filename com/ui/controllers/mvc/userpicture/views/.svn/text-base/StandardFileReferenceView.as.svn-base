package net.interalia.etnia.ui.mvc.userpicture.views {
	...
	public class StandardFileReferenceView extends BasicFileReferenceView implements IView {
		...
		public function StandardFileReferenceView($model:IModel, $controller:IFormController, $graphic:Sprite=null) {
