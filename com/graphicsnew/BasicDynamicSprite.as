package com.etnia.graphic {
	...
	import com.etnia.ui.controllers.events.StageEvent;
...
//			cleanRegisterPoint();
		...
		protected function setRegisterPoint($value:ComplexPoint = null):void {
			...
			_controlsContainer.graphics.clear();
			_controlsContainer.graphics.beginFill(0x005599);
			_controlsContainer.graphics.drawCircle(_registerPoint.x, _registerPoint.y, 5);
